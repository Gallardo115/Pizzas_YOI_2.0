			...
			<nav class="main_nav_container">
				<div class="main_nav">
					<ul class="main_nav_list">
						<li class="main_nav_item"><a href="<?php echo e(route ('index')); ?>">Inicio</a></li>
						<li class="main_nav_item"><a href="<?php echo e(route ('menu')); ?>">Menu</a></li>
						<li class="main_nav_item"><a href="<?php echo e(route ('contact')); ?>">contactanos</a></li>
						<li class="main_nav_item"><a href="<?php echo e(route ('elements')); ?>">elements</a></li>
						<li class="main_nav_item"><a href="<?php echo e(route ('news')); ?>">noticias</a></li>
					</ul>
				</div>
			</nav>
		</div>
...
</html><?php /**PATH C:\xampp\htdocs\PIZZAS_YOI\resources\views/news.blade.php ENDPATH**/ ?>